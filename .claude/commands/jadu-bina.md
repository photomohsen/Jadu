...
- Decks: inspect renders, flow, overlap, copy clarity, hierarchy, consistency, and beginner comprehension when applicable.
...
- "Regenerate Codex UI metadata for `jadu-bina`"
