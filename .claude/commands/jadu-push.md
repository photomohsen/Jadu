...
4. If `git status --short` shows other dirty or untracked files that were **not** touched
   this session, list them explicitly and leave them unstaged — do not add them and do not
...
7. Run `git push`.
8. Report the result as a rigid, unmissable line:
   ...
   checkable. Repeat the list of any files left unstaged from step 4 so nothing is lost
   track of.
